...
| Sendpaymentv2 	            |	Router(lnrpc/routerrpc)		      |	asset_id : uint32, amt_msat : int64             | Request,Response          | [https://api.lightning.community/#sendpaymentv2](https://api.lightning.community/#sendpaymentv2) |
