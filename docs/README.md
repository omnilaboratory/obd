...
Based on the fundamental theory of the Lightning network, OmniBOLT specification describes how to enable OmniLayer assets to be circulated via lightning channels, and how can smart assets benefit from this novel quick payment theory.
...
<p align="center">
  <img width="500" alt="OmniBOLT-Protocol-Suite" src="assets/omni-lightning-3.png">
</p>
