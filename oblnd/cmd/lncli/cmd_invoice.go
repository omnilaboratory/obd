...
var addInvoiceCommand = cli.Command{
	...
	ArgsUsage: "--asset_id --amt_msat --amount --preimage",
	Flags: []cli.Flag{
		cli.StringFlag{
			Name: "memo",
		...
		cli.Int64Flag{
			Name:  "amt_msat",
			Usage: "the amt of millisatoshis in this invoice,for btc transfer",
		},
		cli.Int64Flag{
			Name:  "amount",
			Usage: "the amt of omniAmount in this invoice,for asset transfer",
		},
		cli.StringFlag{
