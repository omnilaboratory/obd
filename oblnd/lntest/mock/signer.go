...
func (s *SingleSigner) SignTransaction(tx *wire.MsgTx) error{
	/*
		todo add SingleSigner.ComputePkhInputScript test code
	*/
	return nil
}
func (s *SingleSigner) ComputePkhInputScript(tx *wire.MsgTx,
	signDesc *input.SignDescriptor) (*input.Script, error) {
	/*
		todo add SingleSigner.ComputePkhInputScript test code
	*/
...
func (s *SingleSigner) ComputeInputScript(tx *wire.MsgTx,
	...
	/*
	bod update wxf
	todo add SingleSigner.ComputeInputScript test code
	*/
	return nil, errors.New("")
	//
	//privKey := s.Privkey
