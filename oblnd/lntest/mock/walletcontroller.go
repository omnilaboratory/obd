...
func (w *WalletController) OB_ListRecAddress() ([]*lnwallet.RecAddress, error) {
	return nil, nil
}
func (w *WalletController) OB_SetDefaultAddress(address string) (err error) {
	return nil
}
func (w *WalletController) OB_GetDefaultAddress() (address btcutil.Address, err error) {
	return nil, nil
}
func (w *WalletController) RecordAddress(address string) (err error) {
	return nil
}
...
func (w *WalletController) ConfirmedBalanceByAddress(confs int32,
...
func (w *WalletController) OB_NewAddress(lnwallet.AddressType, bool,
...
func (w *WalletController) ListUnspentP2pkh(int32, int32,
	string) ([]*lnwallet.Utxo, error) {
	/*todo add ListUnspentP2pkh test code */
	return nil, nil
}

// ListUnspentWitness is called by the wallet when doing coin selection. We just
// need one unspent for the funding transaction.
func (w *WalletController) ListUnspentWitnessDisabled(int32, int32,
	string) ([]*lnwallet.Utxo, error) {
