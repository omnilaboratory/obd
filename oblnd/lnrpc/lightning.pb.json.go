...
func RegisterLightningJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["lnrpc.Lightning.OB_ListAsset"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		resp, err := client.OB_ListAsset(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_ListAddresses"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_ListAddresses(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_ListRecAddress"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &ListRecAddressRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_ListRecAddress(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_SetDefaultAddress"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_SetDefaultAddress(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_GetOmniTransaction"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &GetOmniTransactionRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_GetOmniTransaction(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_ListTranscations"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &ListTranscationsRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_ListTranscations(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_WalletBalanceByAddress"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &WalletBalanceByAddressRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_WalletBalanceByAddress(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_AssetsBalanceByAddress"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &AssetsBalanceByAddressRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_AssetsBalanceByAddress(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_GetAssetInfo"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_GetAssetInfo(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_EstimateFee"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &ObEstimateFeeRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_EstimateFee(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_SendCoinsFrom"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {

		req := &SendCoinsFromRequest{}
		err := marshaler.Unmarshal([]byte(reqJSON), req)
		if err != nil {
			callback("", err)
			return
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_SendCoinsFrom(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_NewAddress"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_NewAddress(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_GetInfo"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_GetInfo(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_OpenChannel"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		stream, err := client.OB_OpenChannel(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_AddInvoice"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_AddInvoice(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_ListInvoices"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_ListInvoices(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["lnrpc.Lightning.OB_ListPayments"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		client := NewLightningClient(conn)
		resp, err := client.OB_ListPayments(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
