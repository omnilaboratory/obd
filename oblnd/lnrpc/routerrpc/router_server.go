...
// OB_SendPaymentV2 attempts to route a payment described by the passed
...
// OB_TrackPaymentV2 returns a stream of payment state updates. The stream is
// closed when the payment completes.
func (s *Server) OB_TrackPaymentV2(request *TrackPaymentRequest,
	stream Router_OB_TrackPaymentV2Server) error {
...
func (s *Server) trackPayment(identifier lntypes.Hash,
	stream Router_OB_TrackPaymentV2Server, noInflightUpdates bool) error {
