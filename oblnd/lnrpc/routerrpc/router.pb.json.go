...
func RegisterRouterJSONCallbacks(registry map[string]func(ctx context.Context,
	...
	registry["routerrpc.Router.OB_SendPaymentV2"] = func(ctx context.Context,
		conn *grpc.ClientConn, reqJSON string, callback func(string, error)) {
		...
		stream, err := client.OB_SendPaymentV2(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
	...
	registry["routerrpc.Router.OB_TrackPaymentV2"] = func(ctx context.Context,
		...
		client := NewRouterClient(conn)
		stream, err := client.OB_TrackPaymentV2(ctx, req)
		if err != nil {
			callback("", err)
			return
		}
