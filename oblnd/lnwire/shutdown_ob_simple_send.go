...
// funding workflow.
type ObShutdownSimpleSend struct {
...
func NewObShutdownSimepleSend(cid ChannelID, addr DeliveryAddress) *ObShutdownSimpleSend {
...
// interface.
var _ Message = (*ObShutdownSimpleSend)(nil)

// Decode deserializes a serialized Shutdown stored in the passed io.Reader
// observing the specified protocol version.
//
// This is part of the lnwire.Message interface.
func (s *ObShutdownSimpleSend) Decode(r io.Reader, pver uint32) error {
...
//
// This is part of the lnwire.Message interface.
func (s *ObShutdownSimpleSend) Encode(w *bytes.Buffer, pver uint32) error {
...
//
// This is part of the lnwire.Message interface.
func (s *ObShutdownSimpleSend) MsgType() MessageType {
	return MsgObShutdownSimpleSend
}
